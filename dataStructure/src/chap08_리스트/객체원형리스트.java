...
class CircularList {
	...
	public CircularList() { // head node
		Node3 nd = new Node3(null);
		nd.link = nd;
		first = nd;
	}

	// delete the element
	public String Delete(SimpleObject3 element, Comparator<SimpleObject3> cc) {
		Node3 ptr = first.link;
		Node3 pre = first;
		SimpleObject3 find = null;

		if (ptr == first)
			return "List가 비어있어 삭제할 수 없습니다.";
		if (!Search(element, cc))
			return "리스트에 " + element + "번이 없습니다.";
	...
	public static void main(String[] args) {
		...
		do {
			...
			case Delete: // 삭제
				...
				String delResult = l.Delete(data, SimpleObject3.NO_ORDER);
