	...
	public static void main(String[] args) {
		...
		do {
			...
			case Add:
				...
				if (result == 1) System.out.println(" 중복 데이터가 존재한다");
				else System.out.println(" 입력 처리됨");
				break;
			...
			case Delete:
				...
				if (result == 1) System.out.println(" 삭제 처리");
			...
			case Search:
				...
				if (result == 1) System.out.println(" 검색 데이터가 존재한다");
				else System.out.println(" 검색 데이터가 없음");
				break;
